...
# pylint: disable=locally-disabled, manifest-required-author
{
    ...
    "depends": [
        ...
        "partner_app",
        "product_app",
        "stock_picking_account_policy",
        "stock_picking_back2draft_policy",
        "stock_picking_invoice_journal_policy",
        "stock_picking_policy",
        "stock_picking_split_policy",
        "stock_picking_subtype_policy",
        "stock_picking_subtype_policy_multi_address",
        "stock_picking_subtype_policy_account",
        "stock_picking_subtype_policy_procurement_group",
    ...
    "data": [
        ...
        "reports/label_aset_tetap.xml",
        "reports/label_inventaris.xml",
